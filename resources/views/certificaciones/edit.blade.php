<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Editar')}} {{ $certificacion->nombre }}</h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{route('update.certificacion', $certificacion)}}" method="POST"
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                name="institucion"
                                value="{{ old('institucion', $certificacion->institucion)?? '' }}"
                            />
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                name="fecha_emision"
                                value="{{ old('fecha_emision', $certificacion->fecha_emision)?? '' }}"
                            />
                        </div>
