...
@section('content')
    <section class="min-h-screen flex items-center justify-center p-8 relative overflow-hidden" id="inicio">
        <div class="max-w-7xl grid md:grid-cols-2 gap-16 items-center z-10">
            <div class="text-left md:order-1">
                <h1 class="text-5xl font-bold mb-4 animate-fadeInUp">Gerardo López Hernández</h1>
                ...
                <a href="{{route('proyectos.guest')}}" class="inline-block px-8 py-4 bg-blue-500 text-white rounded-full text-lg
                font-semibold
                hover:bg-blue-600 transition-all transform hover:-translate-y-1 hover:shadow-lg animate-fadeInUp animation-delay-400">Ver Proyectos</a>
            </div>
    ...
    <section class="py-24 bg-black/30 relative z-10" id="proyectos">
        <div class="max-w-7xl mx-auto px-8">
            <h2 class="text-4xl font-bold mb-12 text-center animate-fadeInUp">Ultimos proyectos</h2>
    ...
    <section class="py-24 relative z-10" id="habilidades">
        <div class="max-w-7xl mx-auto px-8">
            <h2 class="text-4xl font-bold mb-12 text-center animate-fadeInUp">Habilidades</h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white/10 rounded-xl p-6 text-center transition-transform hover:-translate-y-2 animate-fadeInUp">
            ...
            <h2 class="text-4xl font-bold my-12 text-center animate-fadeInUp"></h2>
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white/10 rounded-xl p-6 text-center transition-transform hover:-translate-y-2 animate-fadeInUp">
                ...
                <div class="bg-white/10 rounded-xl p-6 text-center transition-transform hover:-translate-y-2 animate-fadeInUp">
                    <h3 class="text-xl font-semibold mb-4">Idioma</h3>
                    <p>Español nativo</p>
                    <p>Ingles B1</p>
                </div>
                <div class="bg-white/10 rounded-xl p-6 text-center transition-transform hover:-translate-y-2 animate-fadeInUp">
                    <h3 class="text-xl font-semibold mb-4">Programación</h3>
    ...
    <section class="py-24 bg-black/30 text-center relative z-10" id="contacto">
        <div class="max-w-3xl mx-auto px-8">
            <h2 class="text-4xl font-bold mb-4 animate-fadeInUp">¿Iniciamos un proyecto juntos?</h2>
            <p class="text-xl mb-8 opacity-80 animate-fadeInUp">Estoy disponible para nuevos proyectos y colaboraciones</p>
            <div class="space-x-6 animate-fadeInUp">
